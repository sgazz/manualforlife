    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center px-6 py-10">
        <section
          ...
          className="pointer-events-auto w-full max-w-[60ch] rounded-2xl bg-(--theme-surface)/96 px-8 py-10 text-center shadow-(--theme-shadow-soft) transition-all duration-300 ease-in-out sm:px-10 sm:py-12"
        >
