...
export function LiveTrigger({
  ...
  return (
    <button
      ...
      onClick={onToggle}
      className={`bf-trigger fixed top-1/2 z-30 flex h-11 min-h-11 w-11 min-w-11 -translate-y-1/2 items-center justify-center rounded-[999px] border text-sm shadow-(--theme-shadow-soft) transition-[opacity,transform] duration-300 hover:opacity-60 left-[max(1.25rem,env(safe-area-inset-left,0px))] ${
        isOpen
